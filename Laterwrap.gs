 ...
 *   V 논리검증 보고서 / W 논리검증 감사 / (v5) AA 군더더기 보고서 / AB 군더더기 감사)에 $ 없이 노출된 LaTeX
...
const LW = {
  ...
  COLS: [16, 18, 22, 23, 27, 28],   // P, R, V, W, (v5) AA, AB  (판정·정답 값 열 제외)
};
...
function lw_wrapExistingMenu() {
  ...
  var rgRes = ui.prompt(
    ...
    '· 대상 열: P(solution_note), R(error_report), V(논리검증 보고), W(논리검증 감사), AA(군더더기 보고), AB(군더더기 감사)\n' +
